        ...
        try {
            ...
            bwParameter.close();*/
                        ...
                        while(targetArrayListCopy1.size()!=0&&totalSensor !=0) {
                            ...
                            for (int i = 0; i < numberOfSensors; i++) {
                                ...
                                for (int j = 0; j < numberOfSensors; j++) {
                                    ...
                                    if(i==j&&conflictGraph.graphMatrix[i][j].totalConflict>0)
                                    {
                                        ...
                                        if(conflictGraph.graphMatrix[i][j].totalConflict == 99999) finish_check++;
                                        continue;
                                    }
                            ...
                            if(finish_check == numberOfSensors) break;
                            ...
                            if(check==numberOfSensors)
                            {
                                ...
                                while (sensorList.size()!=0)
                                {
                                    ...
                                    for(int i=0;i<coveredTArgets;i++)
                                    {
                                        ...
                                        bool = targetArrayListCopy1.remove(sensorWithOrientationHashMap.get(n * nowSensor + ori).targetArrayList.get(i));
                                        if(bool) counter++;
                                    }
                                    //if (coveredTArgets > 0) {
                                    System.out.println("Targets covered by the current sensor: "+counter);
                                    if(counter>0){
                                        totalSensor--;
                                    }
                                }
                            ...
                            int targetsCovered = sensorWithOrientationHashMap.get(n * minConflictSensor + ori).numberOftagetsCovered;
                            System.out.println("Targets covered by the current sensor: "+targetsCovered);
                            ...
                            System.out.println("currently unused sensor: "+totalSensor);
                        }
