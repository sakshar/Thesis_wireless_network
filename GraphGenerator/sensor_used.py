...
greedy = open("Final Data\\Varying_Sensor_Target_225\\CGA\\sensorUsageRatio.txt", "r")
max_conflict = open("Final Data\\Varying_Sensor_Target_225\\TMxCH\\sensorUsageRatio.txt", "r")
min_conflict = open("Final Data\\Varying_Sensor_Target_225\\TMnCH\\sensorUsageRatio.txt", "r")
max_targetoriented = open("Final Data\\Varying_Sensor_Target_225\\TMxCHSE\\sensorUsageRatio.txt", "r")
...
plt.savefig('Graphs\\RAS_sensor.png')
plt.close(1)

greedy = open("Final Data\\Varying_Target_Sensor_300\\CGA\\sensorUsageRatio.txt", "r")
max_conflict = open("Final Data\\Varying_Target_Sensor_300\\TMxCH\\sensorUsageRatio.txt", "r")
min_conflict = open("Final Data\\Varying_Target_Sensor_300\\TMnCH\\sensorUsageRatio.txt", "r")
max_targetoriented = open("Final Data\\Varying_Target_Sensor_300\\TMxCHSE\\sensorUsageRatio.txt", "r")
...
plt.legend(loc='lower right')
plt.savefig('Graphs\\RAS_target.png')
plt.close(1)