...
greedy = open("Final Data\\Varying_Sensor_Target_225\\CGA\\targetPerSensor.txt", "r")
max_conflict = open("Final Data\\Varying_Sensor_Target_225\\TMxCH\\targetPerSensor.txt", "r")
min_conflict = open("Final Data\\Varying_Sensor_Target_225\\TMnCH\\targetPerSensor.txt", "r")
max_targetoriented = open("Final Data\\Varying_Sensor_Target_225\\TMxCHSE\\targetPerSensor.txt", "r")
...
plt.savefig('Graphs\\TCPS_sensor.png')
plt.close(1)

greedy = open("Final Data\\Varying_Target_Sensor_300\\CGA\\targetPerSensor.txt", "r")
max_conflict = open("Final Data\\Varying_Target_Sensor_300\\TMxCH\\targetPerSensor.txt", "r")
min_conflict = open("Final Data\\Varying_Target_Sensor_300\\TMnCH\\targetPerSensor.txt", "r")
max_targetoriented = open("Final Data\\Varying_Target_Sensor_300\\TMxCHSE\\targetPerSensor.txt", "r")
...
plt.legend(loc='lower right')
plt.savefig('Graphs\\TCPS_target.png')
plt.close(1)